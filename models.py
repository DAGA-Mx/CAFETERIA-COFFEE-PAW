...
### ESCRIBIR LAS FUNCIONES DE CALCULO DE PRODUCTOS
### 07 DE MARZO
...
class Pedido:
    ...
    def validarStock(self, inventario_actual):
        ...
        return f"Verificando ingedrientes disponibles para el pedido #{self.idPedido}... ¡Stock confirmado!"